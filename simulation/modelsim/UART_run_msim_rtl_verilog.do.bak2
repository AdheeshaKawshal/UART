...
vlog -vlog01compat -work cycloneive_ver {c:/intelfpga_lite/22.1std/quartus/eda/sim_lib/cycloneive_atoms.v}
...
vlog -vlog01compat -work work +incdir+D:/UART {D:/UART/TX.v}
vlog -vlog01compat -work work +incdir+D:/UART/output_files {D:/UART/output_files/TX_tb.v}

vlog -vlog01compat -work work +incdir+D:/UART {D:/UART/test_tb.v}
